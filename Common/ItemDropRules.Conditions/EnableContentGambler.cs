...
namespace OrchidMod.Common.ItemDropRules.Conditions
{
	...
	{
		public class EnableContentGambler : IItemDropRuleCondition, IProvideItemConditionDescription
		{
			public bool CanDrop(DropAttemptInfo info) => ModContent.GetInstance<OrchidServerConfig>().EnableContentGambler;
