...
namespace OrchidMod.Gambler.Projectiles
{
	public class SnowCardBase : OrchidModGamblerProjectile
	{
		...
		{
			Projectile.ai[0] = 10;
			bushTexture ??= ModContent.Request<Texture2D>("OrchidMod/Gambler/Projectiles/SnowCardBase", AssetRequestMode.ImmediateLoad).Value;
			fruitTextureOutline ??= ModContent.Request<Texture2D>("OrchidMod/Gambler/Projectiles/SnowCardProj_Outline", AssetRequestMode.ImmediateLoad).Value;
			fruitTexture ??= ModContent.Request<Texture2D>("OrchidMod/Gambler/Projectiles/SnowCardProj", AssetRequestMode.ImmediateLoad).Value;
