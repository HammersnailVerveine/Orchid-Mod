...
namespace OrchidMod.Gambler.Projectiles
{
	public class SnowCardBase : OrchidModGamblerProjectile
	{
		...
		public override void OnSpawn() {
			Projectile.ai[0] = 10;
			bushTexture = bushTexture ?? ModContent.GetTexture("OrchidMod/Gambler/Projectiles/SnowCardBase");
		}
		...
		public override bool OrchidPreDraw(SpriteBatch spriteBatch, Color lightColor) {
			...
			for (int l = 0; l < Main.projectile.Length; l++)
			{
				...
				{
					Texture2D texture = ModContent.GetTexture("OrchidMod/Gambler/Projectiles/SnowCardProj");
