...
namespace OrchidMod.Gambler.Projectiles
{
	public class MushroomCardBase : OrchidModGamblerProjectile
	{
		...
		public override void OnSpawn() {
			Projectile.ai[0] = 10;
			bushTexture = bushTexture ?? ModContent.Request<Texture2D>("OrchidMod/Gambler/Projectiles/MushroomCardBase").Value;
		}
		...
		public override bool OrchidPreDraw(SpriteBatch spriteBatch, Color lightColor) {
			...
			for (int l = 0; l < Main.projectile.Length; l++)
			{
				...
				{
					Texture2D texture = ModContent.Request<Texture2D>("OrchidMod/Gambler/Projectiles/MushroomCardProj").Value;
