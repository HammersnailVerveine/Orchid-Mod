...
namespace OrchidMod.Gambler.Projectiles
{
	public class DesertCardBase : OrchidModGamblerProjectile
	{
		...
		public override void OnSpawn() {
			Projectile.ai[0] = 10;
			bushTexture = bushTexture ?? ModContent.GetTexture("OrchidMod/Gambler/Projectiles/DesertCardBase");
		}
		...
		public override void SafeAI()
		{
			...
			if (Main.myPlayer == Projectile.owner)
			{
				...
				if (cardType != ItemType<Gambler.Weapons.Cards.DesertCard>() || modPlayer.gamblerShuffleCooldown <= 0)
				{
		...
		public override bool OrchidPreDraw(SpriteBatch spriteBatch, Color lightColor) {
			...
			for (int l = 0; l < Main.projectile.Length; l++)
			{
				...
				{
					Texture2D texture = ModContent.GetTexture("OrchidMod/Gambler/Projectiles/DesertCardProj");
