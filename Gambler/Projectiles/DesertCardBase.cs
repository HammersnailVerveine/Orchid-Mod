...
namespace OrchidMod.Gambler.Projectiles
{
	public class DesertCardBase : OrchidModGamblerProjectile
	{
		...
		{
			Projectile.ai[0] = 10;
			bushTexture ??= ModContent.Request<Texture2D>("OrchidMod/Gambler/Projectiles/DesertCardBase", AssetRequestMode.ImmediateLoad).Value;
			fruitTextureOutline ??= ModContent.Request<Texture2D>("OrchidMod/Gambler/Projectiles/DesertCardProj_Outline", AssetRequestMode.ImmediateLoad).Value;
			fruitTexture ??= ModContent.Request<Texture2D>("OrchidMod/Gambler/Projectiles/DesertCardProj", AssetRequestMode.ImmediateLoad).Value;
