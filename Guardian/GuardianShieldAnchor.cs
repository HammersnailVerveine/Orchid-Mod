...
namespace OrchidMod.Guardian
{
	public class GuardianShieldAnchor : OrchidModProjectile
	{
		...
		public override void AI()
		{
			...
			if (item == null || !(item.modItem is OrchidModGuardianShield shamanItem))
			{
				projectile.Kill();
				return;
			}
		...
		public override bool OrchidPreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			if (guardianItem.PreDrawCatalyst(spriteBatch, projectile, player, ref color))
			{
			...
			guardianItem.PostDrawCatalyst(spriteBatch, projectile, player, color);
