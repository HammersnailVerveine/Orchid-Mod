...
{
	public class TopazOrb : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Topaz Orb");
		}
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbSmall != ShamanOrbSmall.TOPAZ || player.GetModPlayer<OrchidModPlayerShaman>().orbCountSmall == 0)
				Projectile.Kill();
