...
{
	public class RubyOrb : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Ruby Orb");
		}
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbSmall != ShamanOrbSmall.RUBY || player.GetModPlayer<OrchidModPlayerShaman>().orbCountSmall == 0)
				Projectile.Kill();
