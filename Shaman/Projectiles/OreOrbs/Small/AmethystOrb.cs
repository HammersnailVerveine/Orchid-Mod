...
namespace OrchidMod.Shaman.Projectiles.OreOrbs.Small
{
	...
	public class AmethystOrb : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbSmall != ShamanOrbSmall.AMETHYST || player.GetModPlayer<OrchidModPlayerShaman>().orbCountSmall == 0)
				Projectile.Kill();
