...
{
	public class DiamondOrb : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Diamond Orb");
		}
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbSmall != ShamanOrbSmall.DIAMOND || player.GetModPlayer<OrchidModPlayerShaman>().orbCountSmall == 0)
				Projectile.Kill();
