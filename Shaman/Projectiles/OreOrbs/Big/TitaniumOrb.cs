...
{
	public class TitaniumOrb : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbBig != ShamanOrbBig.TITANIUM || player.GetModPlayer<OrchidModPlayerShaman>().orbCountBig <= 0)
				Projectile.Kill();
