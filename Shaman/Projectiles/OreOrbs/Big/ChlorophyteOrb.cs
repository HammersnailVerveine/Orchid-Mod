...
{
	public class ChlorophyteOrb : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Chlorophyte Orb");
		}
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbBig != ShamanOrbBig.CHLOROPHYTE || player.GetModPlayer<OrchidModPlayerShaman>().orbCountBig <= 0)
				Projectile.Kill();
