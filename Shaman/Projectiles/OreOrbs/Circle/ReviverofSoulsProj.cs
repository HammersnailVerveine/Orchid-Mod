    ...
    public class ReviverofSoulsProj : OrchidModShamanProjectile
    {
		...
		{	
			...
			if (modPlayer.orbCountCircle == 3) {
				Projectile.NewProjectile(player.Center.X, player.position.Y - 110, 0f, 0f, mod.ProjectileType("ReviverofSoulsFlame"), 0, 0, projectile.owner, 0f, 0f);
			}
			
			if (modPlayer.orbCountCircle == 6)
				Projectile.NewProjectile(player.Center.X  + 55, player.position.Y - 95, 0f, 0f, mod.ProjectileType("ReviverofSoulsFlame"), 0, 0, projectile.owner, 0f, 0f);
			
			if (modPlayer.orbCountCircle == 9)
				Projectile.NewProjectile(player.Center.X  + 95, player.position.Y - 55, 0f, 0f, mod.ProjectileType("ReviverofSoulsFlame"), 0, 0, projectile.owner, 0f, 0f);
			
			if (modPlayer.orbCountCircle == 12)
				Projectile.NewProjectile(player.Center.X + 110, player.position.Y, 0f, 0f, mod.ProjectileType("ReviverofSoulsFlame"), 0, 0, projectile.owner, 0f, 0f);
			...
			if (modPlayer.orbCountCircle == 39)
				player.AddBuff(mod.BuffType("SpiritualBurst"), 60 * 15);
