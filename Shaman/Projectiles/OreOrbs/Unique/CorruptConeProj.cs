		...
		public override void SafeOnHitNPC(NPC target, int damage, float knockback, bool crit, Player player, OrchidShaman modPlayer)
		{
			...
			if (Projectile.penetrate == 3)
			{
				...
				if (modPlayer.orbCountUnique == 1)
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), player.Center.X, player.position.Y - 79, 0f, 0f, Mod.Find<ModProjectile>("CorruptOrb").Type, 0, 0, Projectile.owner, 0f, 0f);
