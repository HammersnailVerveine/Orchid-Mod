...
namespace OrchidMod.Shaman.Projectiles.OreOrbs.Unique
{
	public class TerraScepterOrb3 : OrchidModShamanProjectile
	{
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().orbCountUnique == 0 || player.GetModPlayer<OrchidModPlayerShaman>().orbCountUnique > 19 || player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbUnique != ShamanOrbUnique.TERRA)
				Projectile.Kill();
		...
		public override void Kill(int timeLeft)
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().orbCountUnique < 20)
