...
namespace OrchidMod.Shaman.Projectiles.OreOrbs.Unique
{
	public class TerraScepterOrb3 : OrchidModShamanProjectile
	{
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidShaman>().orbCountUnique == 0 || player.GetModPlayer<OrchidShaman>().orbCountUnique > 19 || player.GetModPlayer<OrchidShaman>().shamanOrbUnique != ShamanOrbUnique.TERRA)
				Projectile.Kill();
		...
		public override void Kill(int timeLeft)
		{
			...
			if (player.GetModPlayer<OrchidShaman>().orbCountUnique < 20)
