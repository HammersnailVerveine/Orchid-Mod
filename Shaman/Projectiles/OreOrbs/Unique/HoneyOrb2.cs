...
namespace OrchidMod.Shaman.Projectiles.OreOrbs.Unique
{
	...
	public class HoneyOrb2 : OrchidModShamanProjectile
	{
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidShaman>().orbCountUnique == 0 || player.GetModPlayer<OrchidShaman>().orbCountUnique > 14 || player.GetModPlayer<OrchidShaman>().shamanOrbUnique != ShamanOrbUnique.HONEY)
				Projectile.Kill();
