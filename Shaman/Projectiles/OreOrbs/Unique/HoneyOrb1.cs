...
namespace OrchidMod.Shaman.Projectiles.OreOrbs.Unique
{
	...
	public class HoneyOrb1 : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		int orbsNumber = 0;
        ...
        public override void AI()
        {
			...
			if (player.GetModPlayer<OrchidModPlayer>().orbCountUnique == 0 || player.GetModPlayer<OrchidModPlayer>().orbCountUnique > 9 || player.GetModPlayer<OrchidModPlayer>().shamanOrbUnique != ShamanOrbUnique.HONEY)
				projectile.Kill();
