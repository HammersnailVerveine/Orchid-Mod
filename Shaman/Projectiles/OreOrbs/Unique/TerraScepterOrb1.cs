	...
	public class TerraScepterOrb1 : OrchidModShamanProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			if (player.GetModPlayer<OrchidModPlayer>().orbCountUnique < 10)
				Projectile.NewProjectile(projectile.position.X, projectile.position.Y, (Main.rand.Next(20) - 10) * 1f, -5f, mod.ProjectileType("TerraScepterOrbHoming1"), dmg, 0f, projectile.owner, 0f, 0f);
		}
	}
}
