...
namespace OrchidMod.Shaman.Projectiles.OreOrbs.Large
{
	public class TrueSanctifyOrb : OrchidModShamanProjectile
	{
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidShaman>().orbCountLarge < 5 || player.GetModPlayer<OrchidShaman>().orbCountLarge > 35 || player.GetModPlayer<OrchidShaman>().shamanOrbLarge != ShamanOrbLarge.TRUESANCTIFY)
				Projectile.Kill();
