...
{
	public class LodestoneOrb : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Lodestone Orb");
		}
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbBig != ShamanOrbBig.LODESTONE || player.GetModPlayer<OrchidModPlayerShaman>().orbCountBig <= 0)
				Projectile.Kill();
