...
namespace OrchidMod.Shaman.Projectiles.Thorium.OreOrbs.Big
{
	...
	public class TitanicOrb : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Titanic Orb");
		}
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbBig != ShamanOrbBig.TITAN || player.GetModPlayer<OrchidModPlayerShaman>().orbCountBig <= 0)
				Projectile.Kill();
