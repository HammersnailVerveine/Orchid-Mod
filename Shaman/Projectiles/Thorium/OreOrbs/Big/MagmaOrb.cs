...
{
	public class MagmaOrb : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbBig != ShamanOrbBig.MAGMA || player.GetModPlayer<OrchidModPlayerShaman>().orbCountBig <= 0)
				Projectile.Kill();
