...
namespace OrchidMod.Shaman.Projectiles.Thorium.OreOrbs.Large
{
	...
	public class TerrariumScepterOrb : OrchidModShamanProjectile
	{
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().orbCountLarge < 5 || player.GetModPlayer<OrchidModPlayerShaman>().orbCountLarge > 35 || player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbLarge != ShamanOrbLarge.TERRARIUM)
				Projectile.Kill();
