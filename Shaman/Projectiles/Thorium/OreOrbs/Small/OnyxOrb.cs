...
namespace OrchidMod.Shaman.Projectiles.Thorium.OreOrbs.Small
{
	...
	public class OnyxOrb : OrchidModShamanProjectile
	{
		float startX = 0;
		float startY = 0;
		...
		public override void AI()
		{
			...
			if (player.GetModPlayer<OrchidModPlayerShaman>().shamanOrbSmall != ShamanOrbSmall.ONYX || player.GetModPlayer<OrchidModPlayerShaman>().orbCountSmall == 0)
				Projectile.Kill();
