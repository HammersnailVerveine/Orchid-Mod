...
{
    public class FireBondProj4 : OrchidModShamanProjectile
    {
        ...
        public override void AI()
        {
			...
			if (projectile.timeLeft % 3 == 0) {
				spawnDustCircle(6, 11 + Main.rand.Next(9));
			}
		}
		...
		public override void Kill(int timeLeft)
        {
			...
			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0f, 0f, mod.ProjectileType("FireBondExplosion3"), projectile.damage, 0.0f, projectile.owner, 0.0f, 0.0f);
