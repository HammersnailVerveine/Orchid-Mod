...
{
	public class AbyssPortalLaser : OrchidModShamanProjectile
	{
		...
		public const float LaserLengthMax = 1500f;
		int multiplier = 1;
		...
		public override void AI()
		{
			...
			if (Main.rand.Next(2) == 0)
			{
				...
				int num811 = Dust.NewDust(endPoint, 0, 0, 172, vector79.X, vector79.Y, 0, default(Color), 1f);
