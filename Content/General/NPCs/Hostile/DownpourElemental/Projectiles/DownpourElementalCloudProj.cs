...
namespace OrchidMod.Content.General.NPCs.Hostile.DownpourElemental.Projectiles
{
	public class DownpourElementalCloudProj : ModProjectile
	{
		...
		{
			int DustID2 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 226, 0f, 0f, 125, default, 1f);
