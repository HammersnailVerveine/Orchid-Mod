namespace OrchidMod.Content.General.Prefixes
{
	...
	public class TimidPrefix : ShapeshifterPrefix { public TimidPrefix() : base(0.85f, 1.00f, -0.10f, 0, -0.10f) { } } // Bad
	public class BoarishPrefix : ShapeshifterPrefix { public BoarishPrefix() : base(1.00f, 0.85f, 0f, 0, -0.10f) { } }
