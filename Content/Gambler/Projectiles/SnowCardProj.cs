...
namespace OrchidMod.Content.Gambler.Projectiles
{
	public class SnowCardProj : OrchidModGamblerProjectile
	{
		...
		public void checkMouseDrag() {
			...
			if (proj.type != ProjectileType<Content.Gambler.Projectiles.SnowCardBase>() || proj.active == false && Projectile.ai[1] != 2f) {
				Projectile.Kill();
			}
		...
		public override void OnKill(int timeLeft)
		{
			...
			int projType = ProjectileType<Content.Gambler.Projectiles.SnowCardProjAlt>();
