...
namespace OrchidMod.Content.Gambler.Projectiles
{
	public class SkyCardProj : OrchidModGamblerProjectile
	{
		...
		public void checkMouseDrag()
		{
			...
			if (proj.type != ProjectileType<Content.Gambler.Projectiles.SkyCardBase>() || proj.active == false && Projectile.ai[1] < 2f)
			{
				Projectile.Kill();
			}
		...
		public override void OnKill(int timeLeft)
		{
			...
			{
				dustid = DustID.Cloud;
				int projType = ProjectileType<Content.Gambler.Projectiles.SkyCardProjAlt>();
