...
namespace OrchidMod.Content.Gambler.Projectiles
{
	public class ForestCardBase : OrchidModGamblerProjectile
	{
		...
		{
			Projectile.ai[0] = 10;
			bushTexture ??= ModContent.Request<Texture2D>("OrchidMod/Content/Gambler/Projectiles/ForestCardBase", AssetRequestMode.ImmediateLoad).Value;
			fruitTextureOutline ??= ModContent.Request<Texture2D>("OrchidMod/Content/Gambler/Projectiles/ForestCardProj_Outline", AssetRequestMode.ImmediateLoad).Value;
			fruitTexture ??= ModContent.Request<Texture2D>("OrchidMod/Content/Gambler/Projectiles/ForestCardProj", AssetRequestMode.ImmediateLoad).Value;
		...
		public override void SafeAI()
		{
			...
			if (Projectile.ai[0] <= 0) {
				Projectile.ai[0] = 90f;
				int projType = ProjectileType<Content.Gambler.Projectiles.ForestCardProj>();
