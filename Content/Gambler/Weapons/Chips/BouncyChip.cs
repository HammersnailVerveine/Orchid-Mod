...
namespace OrchidMod.Content.Gambler.Weapons.Chips
{
	public class BouncyChip : OrchidModGamblerChipItem
	{
		public override void SafeSetDefaults()
		{
			...
			Item.shootSpeed = 10f;
			Item.shoot = ProjectileType<Content.Gambler.Projectiles.Chips.BouncyChipProj>();
			Item.autoReuse = true;
			this.chipCost = 1;
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<Content.Gambler.Weapons.Chips.GamblingChip>(), 1);
