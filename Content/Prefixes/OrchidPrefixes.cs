namespace OrchidMod.Content.Prefixes
{
	...
	public class UnwieldyPrefix : GuardianPrefix { public UnwieldyPrefix() : base(0.85f, 1.00f, 0.90f, 0, 0.90f) { } }
	...
	public class PonderousPrefix : GuardianPrefix { public PonderousPrefix() : base(1.15f, 0.90f, 1f, 1, 1.00f) { } }
	public class StoutPrefix : GuardianPrefix { public StoutPrefix() : base(0.85f, 1.15f, 1f, 0, 1.00f) { } }
	public class WhackingPrefix : GuardianPrefix { public WhackingPrefix() : base(1.10f, 1.00f, 1f, 3, 1.00f) { } }
	public class ToughPrefix : GuardianPrefix { public ToughPrefix() : base(1.00f, 1.10f, 1f, 0, 1.15f) { } }
	public class HulkingPrefix : GuardianPrefix { public HulkingPrefix() : base(1.00f, 1.15f, 1f, 0, 1.10f) { } }
	public class SturdyPrefix : GuardianPrefix { public SturdyPrefix() : base(1.00f, 1.00f, 1.15f, 0, 1.05f) { } }
	public class UnyieldingPrefix : GuardianPrefix { public UnyieldingPrefix() : base(1.10f, 1.05f, 1.1f, 2, 1.05f) { } }
	public class SteadfastPrefix : GuardianPrefix { public SteadfastPrefix() : base(1.10f, 1.00f, 1.15f, 0, 1.00f) { } }
	public class UnmovablePrefix : GuardianPrefix { public UnmovablePrefix() : base(1.15f, 1.10f, 1.15f, 5, 1.10f) { } }
}