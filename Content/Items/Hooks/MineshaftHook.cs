...
namespace OrchidMod.Content.Items.Hooks
{
	...
	internal class MineshaftHookProjectile : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			while (distance > 30f && !float.IsNaN(distance))
			{
				...
				Main.spriteBatch.Draw(Request<Texture2D>("OrchidMod/General/Items/Misc/MineshaftHookChain", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value, new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
