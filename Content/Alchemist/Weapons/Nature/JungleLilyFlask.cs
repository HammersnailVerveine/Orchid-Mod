...
namespace OrchidMod.Content.Alchemist.Weapons.Nature
{
	public class JungleLilyFlask : OrchidModAlchemistItem
	{
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<Content.Alchemist.Misc.EmptyFlask>(), 1);
			recipe.AddIngredient(ModContent.ItemType<Content.General.Materials.JungleLily>(), 2);
			...
			recipe.AddTile(TileID.WorkBenches);
			recipe.AddIngredient(ModContent.ItemType<Content.Alchemist.Misc.EmptyFlask>(), 1);
			recipe.AddIngredient(ModContent.ItemType<Content.General.Materials.JungleLilyBloomed>(), 1);
			recipe.AddIngredient(ItemID.Stinger, 5);
			recipe.Register();
		}
		...
		public override void KillFirst(int timeLeft, Player player, OrchidAlchemist modPlayer, AlchemistProj alchProj, Projectile projectile, OrchidGlobalItemPerEntity globalItem)
		{
			...
			int projType = ProjectileType<Content.Alchemist.Projectiles.Nature.JungleLilyFlaskProj>();
