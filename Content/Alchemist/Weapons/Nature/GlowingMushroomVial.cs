	...
	public class GlowingMushroomVial : OrchidModAlchemistItem
	{
		...
		public override void KillSecond(int timeLeft, Player player, OrchidAlchemist modPlayer, AlchemistProj alchProj, Projectile projectile, OrchidGlobalItemPerEntity globalItem)
		{
			...
			for (int i = 0; i < nb; i++)
			{
				...
				int spawnProj = ProjectileType<Content.Alchemist.Projectiles.Nature.GlowingMushroomVialProjAlt2>();
			...
			for (int l = 0; l < Main.projectile.Length; l++)
			{
				...
				int projType = ProjectileType<Content.Alchemist.Projectiles.Nature.GlowingMushroomVialProj>();
				int projTypeAlt = ProjectileType<Content.Alchemist.Projectiles.Nature.GlowingMushroomVialProjAlt>();
			...
			if (!spawnedMushroom)
			{
				...
				SpawnProjectile(player.GetSource_Misc("Alchemist Attack"), projectile.Center, vel, ProjectileType<Content.Alchemist.Projectiles.Nature.GlowingMushroomVialProj>(), dmg, 0f, projectile.owner);
			}
		}
	}
}
