...
namespace OrchidMod.Content.Alchemist
{
	public class OrchidModAlchemistNPC : GlobalNPC
	{
		...
		public override void Load()
		{
			...
			coatingTextures[0] = ModContent.Request<Texture2D>("OrchidMod/Content/Alchemist/UI/Textures/AlchemistCoatingFire", AssetRequestMode.ImmediateLoad).Value;
			coatingTextures[1] = ModContent.Request<Texture2D>("OrchidMod/Content/Alchemist/UI/Textures/AlchemistCoatingWater", AssetRequestMode.ImmediateLoad).Value;
			coatingTextures[2] = ModContent.Request<Texture2D>("OrchidMod/Content/Alchemist/UI/Textures/AlchemistCoatingNature", AssetRequestMode.ImmediateLoad).Value;
			coatingTextures[3] = ModContent.Request<Texture2D>("OrchidMod/Content/Alchemist/UI/Textures/AlchemistCoatingAir", AssetRequestMode.ImmediateLoad).Value;
			coatingTextures[4] = ModContent.Request<Texture2D>("OrchidMod/Content/Alchemist/UI/Textures/AlchemistCoatingLight", AssetRequestMode.ImmediateLoad).Value;
			coatingTextures[5] = ModContent.Request<Texture2D>("OrchidMod/Content/Alchemist/UI/Textures/AlchemistCoatingDark", AssetRequestMode.ImmediateLoad).Value;
		}
