...
{
	public class RecipeBubbleSlime : AlchemistHiddenReactionRecipe
	{
		public override void SetDefaults()
		{
			this.level = 1;
			this.name = "Slime Bubble";
			this.description = "Creates a catalytic slime bubble";
		...
		public override void Reaction(Player player, OrchidAlchemist modPlayer)
		{
			...
			int itemType = ItemType<Alchemist.Weapons.Water.KingSlimeFlask>();
			int dmg = modPlayer.GetSecondaryDamage(itemType, 4, true);
			int spawnProj = ProjectileType<Content.Alchemist.Projectiles.Reactive.SlimeBubble>();
