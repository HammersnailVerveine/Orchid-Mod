...
{
	public class RecipeBubblePoison : AlchemistHiddenReactionRecipe
	{
		public override void SetDefaults()
		{
			this.level = 2;
			this.name = "Poison Bubble";
			this.description = "Creates a catalytic poison bubble";
		...
		public override void Reaction(Player player, OrchidAlchemist modPlayer)
		{
			...
			int spawnProj = ProjectileType<Content.Alchemist.Projectiles.Reactive.PoisonBubble>();
