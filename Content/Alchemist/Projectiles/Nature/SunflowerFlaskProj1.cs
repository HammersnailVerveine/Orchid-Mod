	...
	public class SunflowerFlaskProj1 : OrchidModAlchemistProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			else
			{
				...
				int projType1 = ProjectileType<Content.Alchemist.Projectiles.Nature.SunflowerFlaskProj2>();
				int projType2 = ProjectileType<Content.Alchemist.Projectiles.Nature.SunflowerFlaskProj3>();
