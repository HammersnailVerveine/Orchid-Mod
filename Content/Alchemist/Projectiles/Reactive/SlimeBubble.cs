...
namespace OrchidMod.Content.Alchemist.Projectiles.Reactive
{
	public class SlimeBubble : AlchemistProjReactive
	{
		...
		public override void SafeKill(int timeLeft, Player player, OrchidAlchemist modPlayer)
		{
			...
			int proj = player.HasBuff(BuffType<Alchemist.Buffs.KingSlimeFlaskBuff>()) ? ProjectileType<Content.Alchemist.Projectiles.Reactive.ReactiveSpawn.AlchemistSlimeJungle>()
			: ProjectileType<Content.Alchemist.Projectiles.Reactive.ReactiveSpawn.AlchemistSlime>();
