	...
	public class BloomingBud : OrchidModAlchemistEquipable
	{
		...
		public override void UpdateAccessory(Player player, bool hideVisual)
		{
			...
			if (modPlayer.alchemistPotencyDisplayTimer > 0 && Main.rand.NextBool(600))
			{
				...
				Projectile.NewProjectile(player.GetSource_Accessory(Item), player.Center.X, player.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, ProjectileType<Content.Alchemist.Projectiles.Reactive.FlowerReactive>(), dmg, 0, player.whoAmI, 0f, 0f);
			}
		}
	}
}