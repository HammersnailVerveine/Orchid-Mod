	...
	public class PoisonVial : OrchidModAlchemistItem
	{
		...
		public override void KillSecond(int timeLeft, Player player, OrchidModPlayerAlchemist modPlayer, AlchemistProj alchProj, Projectile projectile, OrchidModGlobalItem globalItem)
		{
			...
			for (int i = 0; i < nb; i++)
			{
				...
				Projectile.NewProjectile(player.GetSource_Misc("Alchemist Attack"), projectile.Center, vel, ProjectileType<Projectiles.Nature.PoisonVialProj>(), dmg, 0.5f, projectile.owner);
			}
		}
